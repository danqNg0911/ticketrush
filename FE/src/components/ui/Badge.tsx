  ...
  'inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium border transition-colors font-headline uppercase tracking-[0.2em]',
  {
    variants: {
      variant: {
        ...
        warning: 'bg-yellow-700/20 text-yellow-700 font-bold border-yellow-500/30',
        success: 'bg-green-700/20 text-green-700 font-bold border-green-500/30',
        info: 'bg-cyan-700/20 text-cyan-700 font-bold border-cyan-500/30',
